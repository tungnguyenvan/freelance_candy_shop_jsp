...
<%
	...
	List<ProduceModel> produces = mProduceController.index();
	CartController mCartController = new CartController();
	
	if(request.getParameter("cart") != null){
		boolean result = mCartController.insert(Constract.MYMODEL.getId(), Integer.parseInt(request.getParameter("id")));
...
<body class="animsition">
	...
	<section class="slide1">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1 item1-slick1" style="background-image: url(images/bg-1.jpg);">
				...
				<div class="item-slick1 item2-slick1" style="background-image: url(images/bg-2.jpg);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
				...
				<div class="item-slick1 item3-slick1" style="background-image: url(images/bg-3.jpg);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
			...
			<div class="tab01">
				...
				<div class="tab-content p-t-35">
					...
					<div class="tab-pane fade show active" id="best-seller" role="tabpanel">
						<div class="row">
						<%
							for (ProduceModel model : produces){
								%>
								<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
								<!-- Block2 -->
								<div class="block2">
									<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
										<img src="images/<%=model.getImage() %>" alt="IMG-PRODUCT">
										<div class="block2-overlay trans-0-4">
											...
											<div class="block2-btn-addcart w-size1 trans-0-4" >
												...
												if (Constract.MYMODEL != null){
													...
													<button type="submit" name="cart" class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4">
														Add to Cart
													</button>
													</form>
													<%
