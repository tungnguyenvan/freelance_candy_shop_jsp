...
<%
	...
	if(request.getParameter("remove") != null){
		result = mCartController.remove(Integer.parseInt(request.getParameter("id")));
	}
%>
...
<body class="animsition">
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-40 p-b-50 flex-col-c-m" style="background-image: url(images/bg-1.jpg);">
	...
	<%
		for(CartModel cart : carts){
			...
			<tr class="table-row">
				...
				<td class="column-2"><%=model.getName() %></td>
				<td class="column-3">VND <%=model.getPrice() %></td>
				<td>
				<form action="#" method="post">
				<input name="id" value="<%= cart.getId()%>"/>
				<button type="submit" name="remove" class="close column-4" aria-label="Close">
